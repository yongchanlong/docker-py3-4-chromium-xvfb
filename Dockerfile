...
RUN yum -y update && yum -y install wget yum-utils groupinstall development openssl-devel reinstall glibc-common gcc make bzip2 fontconfig freetype libfreetype.so.6 libfontconfig.so.1 libstdc++.so.6 xorg-x11-xauth xorg-x11-utils xorg-x11-fonts-*
